...
export default async function decorate(block) {
  ...
  const variationname = block.querySelectorAll("[data-aue-prop='variation']")[0].textContent
  ...
  <div class='banner-content' data-aue-resource=${itemId} data-aue-type="reference" data-aue-filter="cf">
      <div data-aue-prop="heroImage" data-aue-type="media" class='banner-detail' style="background-image: linear-gradient(90deg,rgba(0,0,0,0.6), rgba(0,0,0,0.1) 80%) ,url(${cfReq.heroImage._publishUrl});">
